# Form implementation generated from reading ui file '/Users/valentinaosoriolopez/Library/CloudStorage/OneDrive-UniversidaddelaSabana/UNIVERSIDAD/9 SEMESTRE/Programación Avanzada/ProyectoFinalPA/ProyectoFinalPA/ui/Programa.ui'
#
...
"border-radius: 10px;")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(130, 60, 381, 161))
        ...
        self.Ltelefono = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.Ltelefono.setObjectName("Ltelefono")
        self.horizontalLayout_5.addWidget(self.Ltelefono)
        ...
        self.Cdirector = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.Cdirector.setObjectName("Cdirector")
        self.horizontalLayout_3.addWidget(self.Cdirector)
        ...
        self.Cdepartamento = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.Cdepartamento.setObjectName("Cdepartamento")
        self.horizontalLayout_7.addWidget(self.Cdepartamento)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Programas"))
        ...
        self.label_5.setText(_translate("MainWindow", "Director de Programa"))
        self.label_7.setText(_translate("MainWindow", "Departamento"))
        self.label.setText(_translate("MainWindow", "Gestión De Programas"))
